        ...
        return this.each(function () {
            ...
            function s() {
                f.width() > 500 ? (f.find(".column_1").css({
                    ...
                    width: "100%",
                    "margin-bottom": "0px"
                }), f.find(".sf-content>li").css({"margin-bottom": "2rem"}), f.find(".sf-steps-content").removeClass("sf-steps-center"), f.find(".sf-steps-navigation").removeClass("sf-align-center").addClass("sf-align-right")) : (f.find(".column_1").css({
                    width: "100%",
                    "margin-bottom": "2rem"
                }), f.find(".column_2").css({
                    width: "100%",
                    ...
                    width: "100%",
                    "margin-bottom": "2rem"
                }), f.find(".sf-content>li").css({"margin-bottom": "0px"}), f.find(".sf-steps-content").addClass("sf-steps-center"), f.find(".sf-steps-navigation").removeClass("sf-align-right").addClass("sf-align-center"))
            }

            function n() {
                f.find(".sf-steps-content>div").removeClass("sf-active"), f.find(".sf-steps-form>.sf-content").css({display: "none"}), f.find(".sf-steps-form>ul").eq(t.active).fadeIn(), f.find(".sf-steps-content>div").eq(t.active).addClass("sf-active"), f.find("#sf-next").text(t.active == c - 1 ? t.sendbtntext : l), f.find("#sf-prev").css(0 == t.active ? {display: "none"} : {display: "inline-block"})
            }
            ...
            var f = $(this), c = f.find(".sf-steps-content").find("div").length, l = f.find("#sf-next").text(),
                h = new Array, u = new Array;
            f.css({width: t.width}), f.addClass("sf-theme-" + t.theme), n(), f.find(":input").on("click", function () {
