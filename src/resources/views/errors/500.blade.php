                ...
                <div class="tab-content-wrapper">
                    <div class="tb-content active" id="home">
                        <div class="box">
                            ...
                            <img src="{{ asset("common/img/500.png") }}" alt="404"/>
                            <p>
                                Các trang web mà bạn đang tìm kiếm đã được di chuyển, xóa, đổi tên hoặc chưa bao giờ tồn tại.
                                <a href="{{ base_url() }}">Click vào đây</a> về trang chủ
                            </p>
                        </div>
                    </div>
                </div>
