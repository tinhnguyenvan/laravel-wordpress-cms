                ...
                <div class="card">
                    ...
                    <div class="card-body collapse show" id="collapseExample">
                        <div class="form-group">
                            <label class="col-form-label" for="title">{{ trans('post_tag.title') }}</label>
                            <div class="controls">
                                <input type="text"
                                       name="title"
                                       id="title"
                        ...
                        <div class="form-group">
                            <label class="col-form-label" for="slug">{{ trans('post_tag.slug') }}</label>
                            <div class="controls">
                        ...
                        <div class="form-group">
                            <label class="col-form-label" for="description">{{ trans('post_tag.description') }}</label>
                            <div class="controls">
                ...
                <div class="row mb-5">
                    <div class="col-lg-12">
                        <div class="form-actions text-lg-right">
                            <form method="post" action="{{ admin_url('post_tags/'.$post_tag->id ) }}">
                                @csrf
                                @method('DELETE')
