    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <form method="post" enctype="multipart/form-data"
                  action="{{ admin_url('post_categorys') }}{{ ($post_category->id ?? 0) > 0 ?'/'.$post_category->id: '' }}">
                @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-body collapse show" id="collapseExample">
                        <div class="form-group">
                            <label class="col-form-label" for="title">{{ trans('post_category.title') }}</label>
                            <div class="controls">
                                <input type="text"
                                       name="title"
                                       id="title"
                        ...
                        <div class="form-group">
                            <label class="col-form-label" for="slug">{{ trans('post_category.slug') }}</label>
                            <div class="controls">
                        ...
                        <div class="form-group">
                            <label class="col-form-label"
                                   for="description">{{ trans('post_category.description') }}</label>
                            <div class="controls">
                ...
                <div class="row mb-5">
                    <div class="col-lg-12">
                        <div class="form-actions text-lg-right">
                            <form method="post" action="{{ admin_url('post_categorys/'.$post_category->id ) }}">
                                @csrf
                                @method('DELETE')
