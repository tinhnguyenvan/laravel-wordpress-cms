                ...
                <div class="card">
                    ...
                    <div class="card-body collapse show" id="collapseExample">
                        <table class="table table-responsive-sm table-bordered">
                            ...
                            <tr>
                                <th></th>
                                <th>{{ trans('contact_form.form_type') }}</th>
                            ...
                            <tr>
                                <td>
                                    <label class="text-success">{{ trans('contact_form.form_title') }}</label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label class="text-success">{{ trans('contact_form.form_content') }}</label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label class="text-success">{{ trans('contact_form.form_fullname') }}</label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label class="text-success">{{ trans('contact_form.form_phone') }}</label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label class="text-success">{{ trans('contact_form.form_email') }}</label>
                                </td>
                                <td>
