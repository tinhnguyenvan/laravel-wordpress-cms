<form action="{{ base_url('contact') }}" method="post">
    ...
    @if(!empty($form->form_fullname_status))
        <div class="form-group">
            <label for="form_fullname">{{ trans('contact_form.form_fullname') }}</label>
    ...
    @if(!empty($form->form_email_status))
        <div class="form-group">
            <label for="form_email">{{ trans('contact_form.form_email') }}</label>
    ...
    @if(!empty($form->form_phone_status))
        <div class="form-group">
            <label for="form_phone">{{ trans('contact_form.form_phone') }}</label>
    ...
    @if(!empty($form->form_title_status))
        <div class="form-group">
            <label for="form_title">{{ trans('contact_form.form_title') }}</label>
    ...
    @if(!empty($form->form_content_status))
        <div class="form-group">
            <label for="form_content">{{ trans('contact_form.form_content') }}</label>
